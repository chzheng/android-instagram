# Project 1 - *android-instagram*

**android-instagram** is an android app that allows a user to check out popular photos from Instagram. The app utilizes Instagram API to display images and basic image information to the user.
...
![Video Walkthrough](MyInstagram.gif)
